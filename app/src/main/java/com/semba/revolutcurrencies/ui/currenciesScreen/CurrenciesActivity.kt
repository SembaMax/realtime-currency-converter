...
import com.semba.revolutcurrencies.databinding.ActivityCurrenciesBinding
...
class CurrenciesActivity : BaseActivity<ActivityCurrenciesBinding, CurrenciesViewModel>(), ICurrenciesNavigator {
    ...
    override fun afterInjection() {
        this.assignViewModel(viewModelFactory, CurrenciesViewModel::class.java)
    ...
    private fun launchInitialApiCall() {
        ...
        notifyWithNewBase(CurrenciesViewModel.defaultBase)
    }
